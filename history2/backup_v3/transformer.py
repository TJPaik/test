...
class HyperTransformer(torch.nn.Module):
    def __init__(self, in_channels, hidden_channels, out_channels, num_layers=1,
        ...
        self.hypergraph_conv3 = HypergraphConv(hidden_channels, hidden_channels, use_attention=True)

        # Batch normalization for each layer
        self.batch_norm1 = BatchNorm1d(hidden_channels)
        self.batch_norm2 = BatchNorm1d(hidden_channels)
        self.batch_norm3 = BatchNorm1d(hidden_channels)
        ...
        # Output projection
        self.pooling_proj = torch.nn.Sequential(
    ...
    def forward(self, x, hyperedge_index, data):
        ...
        # Apply third hypergraph convolution
        x_conv3 = self.hypergraph_conv3(x, hyperedge_index, hyperedge_attr=edge_attr)
        x_conv3 = self.batch_norm3(x_conv3)
