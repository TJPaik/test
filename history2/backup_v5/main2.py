...
if __name__ == '__main__':
    ...
    CONFIG = {
        "hypergraph": {
            ...
            "models": {
                ...
                # },
                "HyperTransformer": {
                    "constructor": lambda in_c, out_c: HyperTransformer(in_channels=in_c, hidden_channels=192, out_channels=out_c, num_layers=3, num_heads=6, dropout=0.15),
                },
            }
        },
        # "bipartite": {
    ...
    for dataset_name, dataset_config in CONFIG.items():
        ...
        for model_name, model_config in dataset_config["models"].items():
            ...
            lit_model = LitGraphModel(model, num_classes=out_channels)
